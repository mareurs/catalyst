...
def _handle_data(context, data):
    ...
    log.info('Current price: ' + str(context.price))
...
if __name__ == '__main__':
    run_algorithm(
        ...
        base_currency='eth',
        start=pd.to_datetime('2017-11-12', utc=True),
        end=pd.to_datetime('2018-01-12', utc=True),
#        live_graph=True,
